...
最終更新: 2026-08-15（ルートのトップページがポータルの劣化コピーになっていたのを作り直し、課題48を追加）
...
**当初の未統合は合計665件。副首都308件・高市140件・高齢者免許61件を統合したので、残りは156件（自転車72・あだ名45・辺野古39）。** 対象テーマの notes には「◯件を追加収集しHermes分類し『世論の潮目』ウィジェットを追加」と書かれており、当時から潮目専用だった。
