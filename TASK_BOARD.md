...
**状態**: 未着手（2026-08-08 に副首都の調査から発見し、全11テーマへ横展開して確認）
**発見**: 2026-08-08
...
**合計665件が未統合。** 対象テーマの notes には「◯件を追加収集しHermes分類し『世論の潮目』ウィジェットを追加」と書かれており、当時から潮目専用だった。
...
**着手順**: 上の表のとおり、各テーマの `collect_at` の収集セッションに組み込む。
**追加のセッション枠は作らない。** どのテーマも収集のために必ず触るため。
