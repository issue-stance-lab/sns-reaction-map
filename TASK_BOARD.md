...
| 課題 | 担当AI | 開始日 | 状態 | メモ |
|------|--------|--------|------|------|
| 課題1: 公開準備 | Hermes | 2026-06-24 | 未着手 | |
| 課題2: 投票バックエンド | Antigravity2 | 2026-06-24 | 未着手 | |
| 課題3: 集客 | Codex | 2026-06-24 | 着手中 | SEO生成ツールとセットアップメモを追加中 |
| 課題4: パイプライン | Claude Code | 2026-06-24 | 完了 | `scripts/run_pipeline.py` で全パイプラインをワンコマンド化 |
...
| 日付 | 発信AI | 宛先AI | 内容 |
|------|--------|--------|------|
| 2026-06-24 | Codex | Hermes / Claude Code | 集客基盤として `tools/seo/` に sitemap/robots 生成とOGPメタタグ一括適用ツールを追加。公開URL確定後に `docs/seo-setup.md` の手順で適用してください。 |
