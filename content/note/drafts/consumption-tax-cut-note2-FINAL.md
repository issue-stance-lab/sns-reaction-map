...
**数字→転換ワード**: 「331件」（ティール、前提の数字）→「変えない」（テラコッタ、転換後のキーワード）
（対象範囲の条件付き賛成331件＝37.4%に対し、大綱の答えは「対象を広げない」だったという、本文の核。
色の割り当てはテンプレートの規則どおり——下書き作成時に一度ここを逆に書いていたが、合成時に訂正した）

【2026-09-22 改訂】初版は「拡大37%→変えない」（%表記）だったが、第1回の「賛成60%→政治不信」と
文字の並び（◯◯%→4文字）がほぼ同型でオーナーから指摘。%をやめて実数（331件）に差し替え、
語尾の記号（%→件）と文字数の型を変えた。
...
消費税減税の「大綱」——政府が9月15日に閣議決定した、制度の実施方針をまとめた文書——は、まず「対象範囲」に答えを出しました。対象は食料品に絞った今の軽減税率のままで、税率は1%、期間は2027年4月からの2年間です。

財源には、大綱も一文しか割いていません。「特例公債には頼らない」。金額は、まだどこにも書いてありません。
...
この記事で分かること
・大綱が出した答えは、対象を広げてほしかった人たちには「変えない」だったこと
・大綱はまだ、財源に慎重な人たちの不安に答えていないこと
...
大綱が出した答えは、その逆でした。対象は現行の軽減税率品目のままで、酒類と外食を除く飲食料品に限り、新聞の定期購読も対象外のまま8%を維持します。実施は2027年4月1日から2029年3月31日までの2年間、税率は1%――この期日まで、もう動きません。

大綱が決まった9月15日を過ぎても、この不満は投稿され続けています。

https://x.com/teramoto_kenta/status/2100204229537517803

対象を広げる案も他にあり、国民民主党は消費税を一律5%にすることを掲げていました。それでも大綱が選んだのは、対象を広げない案でした。
...
財源についても、大綱には一文だけあります。「特例公債には頼らない」。これだけ見れば、財源にも答えが出ているように見えます。
...
対象範囲は、もう動かないところまで来ました。実施日と税率まで決まった話を、大綱は後から覆す理由を示していません。
