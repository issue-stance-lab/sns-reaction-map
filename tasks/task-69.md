...
### 2026-09-22 部活動の地域移行（2巡目）を型どおり実施

新規108件（意見82件）→正典1,726件・意見1,401件。未読率最大19.5%で追い読み不要、
語られていない争点は再検索3件を本文確認して該当なし。潮目ラベルの重なり（minGap不足）を
部活動のみ修正。詳細は[themes/bukatsu-chiiki.md](../themes/bukatsu-chiiki.md)。
