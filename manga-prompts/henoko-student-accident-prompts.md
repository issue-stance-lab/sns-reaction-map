...
- 役割: 文部科学省 初等中等教育局 調査官（42歳）
- 立場: 教育基本法違反の認定は妥当であり、政治的中立性は教育の根幹
- 恐れ: 教育現場が特定の政治活動に利用されること
- 望み: すべての生徒が偏りのない教育を受けられる環境

```
Character design reference sheet, white background, multiple expressions (stern, thoughtful, conflicted, resolute, sympathetic), full body and close-up face views. Japanese male government official, age 42, neatly combed short black hair with slight graying at temples, rectangular glasses, dark charcoal suit with white shirt and navy tie, holding official documents with ministry seal. Medium build, upright posture, bureaucratic but not heartless. Anime-inspired semi-realistic manga style, clean line art, formal government office color palette.
```
