...
```bash
cd /Volumes/M2-WorkSpace/Projects/副業/issue-stance-aggregator && git fetch origin && git worktree add ../isa-wt-constitutional-arena -b task/constitutional-arena origin/main
```
