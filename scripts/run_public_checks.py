...
CHECKS: tuple[tuple[str, list[str]], ...] = (
    ...
    ("データの保存境界と復元記録", ["scripts/verify_data_assets.py"]),
)
...
PRIVATE_DATA_TESTS: dict[str, str] = {
    ...
    "test_fukushuto_public_counts": "副首都の再生成（build_planet_data.py経由）が非公開正典を読む",
    "test_fukushuto_taxonomy": "副首都の正典レコードを分類体系と突き合わせる",
    "test_koshitsu_adapter": "皇室典範の公開ページ再生成（--check）が非公開正典を読む",
