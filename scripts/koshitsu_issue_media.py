...
MEDIA = {
'patrilineal-matrilineal': ('keisho-v4', '男系を維持する考えと女系も認める考え、改正後も変わらない第一条を示す図解。', [('benjymin84/2081234225664262600','男系の継承を重視','女性天皇への否定とは分けて、男系の継承を続けたいと述べています。'),('a_aok04352/2080825663821615144','男女を問わない安定継承を求める','従来の仕組みを続ける難しさを挙げ、男女を問わず継承できる制度を求めています。')]),
'female-emperor': ('josei-tenno-v2', '女性天皇と女系天皇の違い、現行の継承資格を示す図解。', [('5VcfqTGE08SrXGE/2081146247327760862','女系への移行を懸念','結婚できる女性天皇が女系の継承につながることを懸念しています。'),('ayumuchan3/2081231595923734681','女性天皇となる可能性に言及','投稿者は、愛子さまの教育方針を、将来のさまざまな立場に備えるものと捉えています。')]),
'former-royal-adoption': ('yoshi-v2', '旧宮家につながる男子の養子縁組と、その本人・子孫の継承資格を示す図解。', [('kazuhi2024/2081201410503492037','法の下の平等との関係を問う','旧宮家の男系男子を対象にすることについて、憲法との関係を議論すべきだと問いかけています。'),('fi44504/2081220792025764197','養子による男系の維持を評価','旧宮家からの養子によって、男系の宮家を存続させる考えを支持しています。')]),
'princess-aiko': ('aiko-v2', '女性皇族の婚姻後の身分と、配偶者・子の扱いを示す図解。', [('so_far_away0712/2081023992228630655','現行の継承資格を重視','個人への支持と、法律で定める継承資格を分けて考える立場です。'),('Aruhuvrv0/2081152597432688720','女性皇族と子の地位を提案','女性皇族の婚姻後の皇籍維持に加え、その子も皇族とする解決策を提案しています。')]),
