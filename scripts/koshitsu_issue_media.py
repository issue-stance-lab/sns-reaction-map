...
'female-emperor': ('josei-tenno', '旧図解です。画像の支持率には出典の再確認が必要です。また、在位中の天皇を皇位継承順位に含める表記は誤りです。女性天皇と女系天皇は異なる概念です。', [('5VcfqTGE08SrXGE/2081146247327760862','女系への移行を懸念','女性皇族の婚姻後の地位と、女系による継承への懸念を結び付けています。'),('ayumuchan3/2081231595923734681','女性天皇となる可能性に言及','投稿者は、愛子さまの教育方針を、将来のさまざまな立場に備えるものと捉えています。')]),
