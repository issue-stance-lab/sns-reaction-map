...
FACT_CHECKS = [
    ...
    },
    {
        "key": "legal",
        "issues": ["自主返納支援"],
        "claim": "自主返納に法的な根拠はない／いや、法的には申請による免許取消し処分だ",
        ...
        "verdict": "gap",
        "verdict_label": "一方だけが資料と一致",
        "note": "返納は法律に手続が定められた「申請による取消し」で、件数も毎年公表されている。「根拠はない」は資料と食い違い、「申請による免許取消し処分」と書いた投稿の方が条文どおり。なお「70歳から返納者が増える」という部分は、申請取消の86.2％が70歳以上という統計と方向としては合っている。",
        "url": "https://laws.e-gov.go.jp/law/335AC0000000105",
        "url_label": "e-Gov法令検索 道路交通法（第百四条の四・第百五条の二）",
    },
    {
        "key": "transit",
        "issues": ["地方の足・移動権", "代替交通整備"],
