...
THEMES = [
    {
        ...
        "note": "比較対象：7月12日収集分のうち意見投稿／7月26日収集分のうち意見投稿。同じ検索語セットで取得した投稿をHermesで再分類しています。サンプルの構成比の変化であり、同じ人の意見が移動したことや世論全体の変化を示すものではありません。",
    },
    {
    ...
    },
    {
        ...
        "prev_file": "bike-blue-ticket_hermes_prev_20260712.json",
        "cur_file": "bike-blue-ticket_hermes_cur_20260726.json",
        "prev_label": "7月12日",
        "cur_label": "7月26日",
        ...
        "note": "比較対象：7月12日収集分のうち賛否を含む意見投稿／7月26日収集分。同じ検索語セットで取得した投稿をHermesで再分類しています。",
    },
    {
        "slug": "henoko",
    ...
    },
    {
        ...
        "note": "比較対象：7月12日収集分のうち意見投稿／7月26日収集分のうち意見投稿。同じ検索語セットで取得した投稿をHermesで再分類しています。",
    },
    {
        "slug": "ai-copyright",
        ...
        "issue_labels": ["学習データ無断利用", "クリエイター保護", "法制度整備", "技術競争・AI推進", "利用者モラル・AI生成物"],
        "note": "比較対象：7月12日収集分のうち意見投稿／7月26日収集分のうち意見投稿。同じ検索語セットで取得した投稿をHermesで再分類しています。サンプルの構成比の変化であり、同じ人の意見が移動したことや世論全体の変化を示すものではありません。",
    },
    {
        "slug": "fukushuto",
        ...
        "note": "比較対象：7月14日収集分のうち意見投稿／7月26日収集分のうち意見投稿。同じ検索語セットで取得した投稿をHermesで再分類しています。",
    },
    {
        ...
        "note": "比較対象：7月17日収集分の2Dスタンス統計（改正成立直後326件）と7月26日収集分のHermes分類（347件）。前回は2D分類データを再構成した参考値です。同じ人の意見が移動したことや世論全体の変化を示すものではありません。",
    },
]
