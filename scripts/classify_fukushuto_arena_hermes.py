#!/usr/bin/env python3
"""Classify fukushuto (副首都法案) reactions with Hermes for the issue arena."""
...
背景:
日本維新の会が推進する「副首都推進法案」は、大阪を首都機能のバックアップとする構想に基づく。
推進派は首都直下地震などへの備えや首都機能分散の必要性を訴える。
反対派は大阪・関西優遇、財政負担、実現可能性の乏しさを問題視している。
