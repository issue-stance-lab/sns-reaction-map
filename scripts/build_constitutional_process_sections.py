...
FACT_CHECKS = [
    ...
    },
    {
        ...
        "source": (
            ...
            "稲田朋美防衛大臣は2016年10月11日の参議院予算委員会で"
            "「徴兵制は憲法十八条が禁止をするところの苦役に当たります」と答弁している。"
    ...
    },
    {
        ...
        "source": (
            "安倍晋三内閣総理大臣は2017年5月9日の参議院予算委員会で"
            "「七割、八割の方々が違憲と言っていて、その記述は教科書の中にもある」と述べ、"
            "憲法学者の多数が自衛隊を違憲とする見解をとっていることを認めた。"
        ...
        "note": (
            ...
            "合憲・違憲どちらが正しいかについては、この答弁は判断していない。"
        ),
