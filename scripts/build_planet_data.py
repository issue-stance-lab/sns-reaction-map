...
# この6テーマは #issue-cards（画像＋X投稿カード、*_issue_media.py 等が生成）が既に
...
ISSUE_CARDS_OWNS_ANCHOR_ID = {
    ...
    "consumption-tax-cut", "koshitsu-tenpakai", "fukushuto",
}
...
def render_page(data: dict, template: str, payload: str) -> str:
    ...
    if data["theme_id"] in (
        ...
        "fukushuto", "henoko-student-accident", "school-nickname-ban",
    ):
