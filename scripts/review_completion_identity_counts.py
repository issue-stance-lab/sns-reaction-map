"""Body-free duplicate accounting; global IDs are reference counts, not exclusions.
...
"""
    ...
    return {
        ...
        'reference': {
            ...
            'global_id_body_classification_duplicate_excess_rows': len(rows) - len({
                key(row, ('record_id_hash', 'body_sha256', 'classification_sha256')) for row in rows}),
