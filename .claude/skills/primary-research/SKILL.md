...
3. 一次資料の定義を厳密に守って調べる（省庁・国会会議録・e-Gov・自治体・政党の公表資料のみ）。
   ...
   **採用した前例（同じ形なら同じ判断でよい。ただし採用したことをメモに明記すること）:**
   - 日本中体連の競技部細則（大会参加資格）— bukatsu-chiiki 資料K-0
   - スポーツ安全協会のスポーツ安全保険の補償額 — bukatsu-chiiki 資料W（2026-09-07 採用）
   いずれも「その団体が自ら定め、自ら公表している制度の条件」であることが理由。
   **第三者の解説記事・まとめ・報道は、この例外に当たらない（引き続き不採用）。**
