...
> **2026-09-06 棚卸しによる訂正：読む量・読了数の記述は旧見積もり。** 「273＋77件読了」「残4〜26件」は読了数として使わない。273件のうち93件はAI分類から自動生成され、本文編集再読の根拠がない。 最新の[全10テーマ棚卸し](../reviews/2026-09-06-reread-inventory.md)とID作業一覧を使う。以下は当時の設計・経緯として保存し、再読の発注数には転用しない。
