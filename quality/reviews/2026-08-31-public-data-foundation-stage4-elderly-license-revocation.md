...
- 論点カードの出所を `data/public/themes/elderly-license-revocation.json` に変更した。
...
- 公開候補の実地生成: 公開JSONとページの意見258件が一致
- 承認用マニフェスト: ページを含む21ファイルを固定
- `verify_public_registry.py --public-only`: OK
- `verify_theme_page.py elderly-license-revocation`: NG 0件
- `verify_number_provenance.py elderly-license-revocation`: NG 0件
- 全unittest: 339件成功
